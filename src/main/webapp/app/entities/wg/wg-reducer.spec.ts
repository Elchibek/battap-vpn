...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './wg.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WG_LIST actions', async () => {
    ...
    it('dispatches FETCH_WG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WG actions', async () => {
      const expectedActions = [
        {
