...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tunnel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TUNNEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_TUNNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TUNNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TUNNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TUNNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TUNNEL actions', async () => {
      const expectedActions = [
        {
