...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIRSERVER_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIRSERVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIRSERVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIRSERVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIRSERVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIRSERVER actions', async () => {
      const expectedActions = [
        {
